...
public class Meta_Quest_Markers_Manager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Calibrated)
        {
            ...
            ViconWorldTransformation = ScaleMatrix.MultiplyPoint3x4(RotateY.MultiplyPoint3x4(SwizzleYandZ.MultiplyPoint3x4((Root_Meta_Quest_Marker.GlobalMarkerPositions["HMD1"] + Root_Meta_Quest_Marker.GlobalMarkerPositions["HMD2"]) / 2)));
            ...
            foreach (var TrackedSubject in TrackedMetaQuestSubjects)
            {
                ...
                // Debug.LogError($"RotateY: {RotateY} ScaleMatrix: {ScaleMatrix}");
            }
        }
    }
